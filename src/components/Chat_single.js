        ...
        <div className="chat_single flex">
                        ...
                        <div className="h-[40px] w-[40px] flex items-center justify-center cursor-pointer rounded-full active:bg-[#0F1110]" onClick={setSearchMessagesWidthTrue} title="Search...">
                            ...
                            <div className="relative">
                                ...
                                <div className={ menu ? "bg-white rounded-sm shadow-md py-[6px] absolute top-[46px] left-[-200px] w-[230px] h-[252px] animate-chat_single_menu overflow-hidden" : "w-0 h-0 overflow-hidden" }>
                                    <p className="h-[40px] text-[#3b4a54] text-[15px] leading-[40px] hover:bg-[#ececec] hover:transition-all px-6 cursor-pointer" onClick={setProfileDetailsTrue}>Contact info</p>
                    ...
                    {chat.map((val, key) => {
                      return (
                        ...
                        <div className={ val.isSentByMe === true ? "w-full flex justify-end my-1" : "w-full flex justify-start my-1" }>
                            <div className={ val.isSentByMe === true ? "max-w-[60%] bg-[#1E2321] text-[#ffffffe6]  rounded-md text-[14px] flex shadow-sm" : "max-w-[60%] bg-white text-[#111b21] h- text-[14px] rounded-md flex shadow-sm" }>
                                <div className="leading-[20px] px-2 py-[7px]">
                                    {val.message}
                                </div>
                                <div className="flex items-end pb-[5px] text-[#ffffffe6] text-[12px] leading-[15px] pr-2">
            ...
            <div className={ searchMessagesWidth === "" ? "h-[100vh] w-[0px] overflow-hidden" : searchMessagesWidth ? "animate-search_messages_full overflow-hidden" : "animate-search_messages_zero overflow-hidden"  }>
                <div className="h-[60px] bg-[#1E2321] flex items-center px-4 shadow-sm grow-0 shrink-0 border-l border-[#D1D7DB]">
                    <svg viewBox="0 0 24 24" height="24" width="24" preserveAspectRatio="xMidYMid meet" class="mr-7 cursor-pointer" fill="#ffffffe6" enable-background="new 0 0 24 24" onClick={setSearchMessagesWidthFalse}>
            ...
            <div className={ profileDetails === "" ? "h-[100vh] w-[0px] overflow-hidden" : profileDetails ? "animate-search_messages_full overflow-hidden" : "animate-search_messages_zero overflow-hidden"  }>
                <div className="profile_self hidden">
                    <div className="h-[60px] bg-[#1E2321] flex items-center px-4 shadow-sm grow-0 shrink-0 border-l border-[#D1D7DB]">
                        <svg viewBox="0 0 24 24" height="24" width="24" preserveAspectRatio="xMidYMid meet" class="mr-7 cursor-pointer" fill="#ffffffe6" enable-background="new 0 0 24 24" onClick={setProfileDetailsFalse}>
                            <path d="M19.6004 17.2L14.3004 11.9L19.6004 6.60005L17.8004 4.80005L12.5004 10.2L7.20039 4.90005L5.40039 6.60005L10.7004 11.9L5.40039 17.2L7.20039 19L12.5004 13.7L17.8004 19L19.6004 17.2Z"></path>
                        </svg>
                ...
                <div className="profile_normal hidden">
                    <div className="h-[60px] bg-[#1E2321] flex items-center px-4 shadow-sm grow-0 shrink-0 border-l border-[#D1D7DB]">
                        <svg viewBox="0 0 24 24" height="24" width="24" preserveAspectRatio="xMidYMid meet" class="mr-7 cursor-pointer" fill="#ffffffe6" enable-background="new 0 0 24 24" onClick={setProfileDetailsFalse}>
                            <path d="M19.6004 17.2L14.3004 11.9L19.6004 6.60005L17.8004 4.80005L12.5004 10.2L7.20039 4.90005L5.40039 6.60005L10.7004 11.9L5.40039 17.2L7.20039 19L12.5004 13.7L17.8004 19L19.6004 17.2Z"></path>
                        </svg>
