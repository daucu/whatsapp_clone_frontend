    ...
    <div>
        ...
        <div className="flex items-center">
            ...
            <div className="relative">
                ...
                <div className={ menu ? "bg-white rounded-sm shadow-md py-[6px] absolute top-[46px] left-[-200px] w-[230px] h-[372px] animate-chat_single_menu overflow-hidden" : "w-0 h-0 overflow-hidden" }>
