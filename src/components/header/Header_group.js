  ...
  return (
    <div>
        ...
        <div className="flex items-center grow shrink" onClick={()=>changeIsProfileOpen(true)}>
            { chatProfile.dp ? (<div className="rounded-full h-[40px] w-[40px] bg-cover bg-center mr-4 cursor-pointer grow-0 shrink-0" style={{ backgroundImage:`url(${chatProfile.dp})` }} title="Profile Details"></div>) : (<div className='h-[40px] w-[40px] rounded-full mr-4'>{contactIconDefault}</div>) }
            ...
            <div className="flex items-center">
                ...
                <div className="h-[40px] w-[40px] flex items-center justify-center cursor-pointer rounded-full active:bg-[#0F1110]" title="Search..." onClick={()=>changeSearchMessages(true)}>
                ...
                <div className="relative">
                    ...
                    <div className={ menu ? "bg-white rounded-sm shadow-md py-[6px] absolute top-[46px] left-[-200px] w-[230px] h-[212px] animate-chat_single_menu overflow-hidden" : "w-0 h-0 overflow-hidden" }>
                        <p className="h-[40px] text-[#3b4a54] text-[15px] leading-[40px] hover:bg-[#ececec] hover:transition-all px-6 cursor-pointer" onClick={()=>changeIsProfileOpen(true)}>Group info</p>
