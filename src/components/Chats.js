                ...
                <div className="h-[60px] bg-[#1E2321] flex items-center justify-between px-4">
                    ...
                    <div className="flex items-center">
                        ...
                        <div className="w-[40px] h-[40px] flex items-center justify-center ml-[10px] cursor-pointer rounded-full active:bg-[#0F1110]" title="New chat" onClick={SetNewChatsTrue}>
                            <svg viewBox="0 0 24 24" height="24" width="24"  class="fill-white" >
                                <path fill="white" enable-background="new    " d="M19.005,3.175H4.674C3.642,3.175,3,3.789,3,4.821V21.02 l3.544-3.514h12.461c1.033,0,2.064-1.06,2.064-2.093V4.821C21.068,3.789,20.037,3.175,19.005,3.175z M14.016,13.044H7.041V11.1 h6.975V13.044z M17.016,9.044H7.041V7.1h9.975V9.044z"></path>
                            </svg>
                        </div>
