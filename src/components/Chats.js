    ...
    return(
        <div>
            <div className={ newChats === "" ? "h-screen w-[400px] fixed left-[-400px] z-10 bg-white" : newChats ? "animate-new_chats_show fixed w-[400px] bg-white z-10" : "animate-new_chats_hide fixed w-[400px] bg-white z-10" }>
                <div className="h-[108px] bg-[#008069] flex flex-col justify-end">
                    <div className="h-[54px] w-full flex items-center ">
                        <svg viewBox="0 0 24 24" height="24" width="24" preserveAspectRatio="xMidYMid meet" class="fill-white mx-6 cursor-pointer" version="1.1" x="0px" y="0px" enable-background="new 0 0 24 24" onClick={setNewChatsFalse}>
            ...
            <div className={ community === "" ? "h-screen w-[400px] fixed left-[-800px] z-10 bg-white" : community ? "animate-communities_show fixed w-[400px] bg-white z-10" : "animate-communities_hide fixed w-[400px] bg-white z-10" }>
                <div className="h-[108px] bg-[#008069] flex flex-col justify-end">
                    <div className="h-[54px] w-full flex items-center ">
                        <svg viewBox="0 0 24 24" height="24" width="24" preserveAspectRatio="xMidYMid meet" class="fill-white mx-6 cursor-pointer" version="1.1" x="0px" y="0px" enable-background="new 0 0 24 24" onClick={setCommunityFalse}>
                            <path fill="white" d="M12,4l1.4,1.4L7.8,11H20v2H7.8l5.6,5.6L12,20l-8-8L12,4z"></path>
                        </svg>
                        <p className="text-[19px] text-white font-medium">Communities</p>
                    </div>
                </div>
