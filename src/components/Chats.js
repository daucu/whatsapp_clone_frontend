...
function Chats(){
    ...
    return(
        <div>
            ...
            <div className={ starredMessages === "" ? "h-screen w-[400px] fixed left-[-800px] z-10 bg-white" : starredMessages ? "animate-communities_show fixed w-[400px] bg-white z-10" : "animate-communities_hide fixed w-[400px] bg-[#f0f2f5] z-10" }>
