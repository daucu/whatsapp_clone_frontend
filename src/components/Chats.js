            ...
            <div className="w-[400px] border-r border-[#D1D7DB]">
                <div className="h-[60px] bg-[#f0f2f5] flex items-center justify-between px-4">
                    ...
                    <div className="flex items-center">
                        <div className="w-[40px] h-[40px] flex items-center justify-center ml-[10px] cursor-pointer" title="Communities" onClick={SetCommunityTrue}>
                            <svg viewBox="0 0 24 24" height="24" width="24"  class="fill-[#54656f] relative top-[-3px]">
                        ...
                        <div className="w-[40px] h-[40px] flex items-center justify-center ml-[10px] cursor-pointer" title="status">
                        ...
                        <div className="w-[40px] h-[40px] flex items-center justify-center ml-[10px] cursor-pointer" title="New chat" onClick={SetNewChatsTrue}>
                            <svg viewBox="0 0 24 24" height="24" width="24"  class="fill-[#54656f]" >
                        ...
                        <div className="relative">
                                <div className="w-[40px] h-[40px] flex items-center justify-center ml-[10px] cursor-pointer rounded-full hover:bg-[#D9DBDE]" title="Menu" onClick={SetMenuChats}>
                                    <svg viewBox="0 0 24 24" height="24" width="24"  class="fill-[#54656f]" >
