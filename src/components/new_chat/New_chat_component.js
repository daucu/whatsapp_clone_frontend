...
import { Group_icon_red, Community_icon_new_chats } from "./../Svg.js";
import "./New_chat.css";
function New_chats(props){
    return(
            <div className="w-[400px] h-screen">
                <div className="h-[108px] bg-[#A52729] flex flex-col justify-end">
                    <Link to="/" className="h-[54px] w-full flex items-center">
                        <svg viewBox="0 0 24 24" height="24" width="24" preserveAspectRatio="xMidYMid meet" class="fill-[#ffffffe6] mx-6 cursor-pointer" version="1.1" x="0px" y="0px" enable-background="new 0 0 24 24" onClick={props.newChats}>
                ...
                <div className="scroll_container overflow-y-scroll h-[calc(100vh-158px)]">
                    <Link to="/group" className="flex hover:bg-[#ececec] hover:transition-all cursor-pointer">
                    ...
                    <Link to="/community" className="flex hover:bg-[#ececec] hover:transition-all cursor-pointer">
                        <div className="h-[72px] w-[76px] grow-0 shrink-0 flex items-center justify-center">
                            <div className="w-[48px] h-[48px] rounded-full bg-[#a52729] flex items-center justify-center">
