  ...
  return (
    <div className="h-[64px] bg-[#1e2321] flex items-center px-4 shadow-sm grow-0 shrink-0">
      ...
      <div className="h-[52px] w-[40px] flex items-center justify-center cursor-pointer mr-[10px] relative" title="Attach">
        <div className={ attach === "" ? "hidden" : attach ? "relative top-[-220px] left-[-10px] flex flex-col h-0 justify-evenly animate-attach_up" : "relative top-[-200px] flex flex-col h-0 justify-evenly overflow-hidden animate-attach_down" }>
          <div className="absolute flex flex-col items-center">
          <div className={ attach ? "rounded-full my-[6px] shadow-lg animate-scale_up h-0 w-0 overflow-hidden" : "h-[53px] w-[53px] rounded-full my-[6px] shadow-lg animate-scale_down delay-1200" } style={{
            animationDelay: "0.5s",
          }}>
