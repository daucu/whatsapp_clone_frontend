        ...
        <div className="settings h-screen max-h-screen">
            <div className="h-[108px] bg-[#A52729] flex flex-col justify-end">
                <div className="h-[54px] w-full flex items-center">
                    ...
                    <p className="text-[19px] text-[#ffffffe6] font-medium">Last seen and online</p>
                </div>
            </div>
                
            <div className="settings overflow-y-scroll h-[calc(100vh-108px)] bg-[#E9EBEE]">
                <div className="px-[30px] bg-white shadow-sm">
                    <p className="text-[#a52729] text-[14px] leading-[17px] py-[19px]">Who can see my last seen</p>
                    <div>
                    ...
                    <div className="h-[20px] border-b border-gray-900"></div>
                    <p className="text-[#a52729] text-[14px] leading-[17px] py-[19px]">Who can see my when i'm online</p>
                    <div>
                        <div className="flex items-center py-[18px]">
                            <input type="radio" name="" id="" className="w-[18px] h-[18px] mr-5"/>
                            <p className="text-[16px] leading-[20px] text-[#3b4a54]">Everyone</p>
                        ...
                        <div className="flex items-center py-[18px]">
                            <input type="radio" name="" id="" className="w-[18px] h-[18px] mr-5"/>
                            <p className="text-[16px] leading-[20px] text-[#3b4a54]">Same as last seen</p>
                        </div>
                    </div>
                    <p className="py-[40px] text-[#667781] text-[12px] leading-[15px]">If you don't share your <b>last seen</b> and <b>online</b> you won't be able to other people's last seen and online</p>
                </div>
            </div>
        </div>
    )
