        ...
        <div className="settings h-screen max-h-screen">
            <div className="h-[108px] bg-[#A52729] flex flex-col justify-end">
                <div className="h-[54px] w-full flex items-center">
                    ...
                    <p className="text-[19px] text-[#ffffffe6] font-medium">Groups</p>
                </div>
            </div>
                
            <div className="settings overflow-y-scroll h-[calc(100vh-108px)] bg-[#E9EBEE]">
                <div className="px-[30px] bg-white shadow-sm">
                    <p className="text-[#a52729] text-[14px] leading-[17px] py-[19px]">Who can add me to groups</p>
                    <div>
                    ...
                    <p className="text-[#a52729] text-[14px] leading-[17px] py-[19px]">Admins who can't add you to group will have option of inviting you privately instead.</p>
                </div>
            </div>
        </div>
    )
