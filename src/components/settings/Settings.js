...
function Settings(props){
    return (
        <div className="settings h-screen max-h-screen">
            ...
            <div className="settings overflow-y-scroll h-[calc(100vh-108px)]">
                <div className="h-[50px] flex items-center px-[10px] grow-0 shrink-0 shadow-md">
                ...
                <div className="h-[114px] flex my-2 hover:bg-[#F5F6F6] hover:transition-all">
                ...
                <div>
                    <div className="h-[60px] hidden items-center hover:bg-[#F5F6F6] hover:transition-all">
                    ...
                    <Link to="/settings/notifications" className="h-[60px] flex items-center hover:bg-[#F5F6F6] hover:transition-all">
                        <div className="w-[74px] flex items-center justify-center">
                    ...
                    <Link to="/settings/privacy" className="h-[60px] flex items-center hover:bg-[#F5F6F6] hover:transition-all">
                        <div className="w-[74px] flex items-center justify-center">
                    ...
                    <div className="h-[60px] flex items-center hover:bg-[#F5F6F6] hover:transition-all">
                        <div className="w-[74px] flex items-center justify-center">
                    ...
                    <Link to="/settings/help" className="h-[60px] flex items-center hover:bg-[#F5F6F6] hover:transition-all">
                        <div className="w-[74px] flex items-center justify-center">
                            <svg viewBox="0 0 24 24" height="24" width="24" preserveAspectRatio="xMidYMid meet" class="" version="1.1" x="0px" y="0px" enable-background="new 0 0 24 24">
