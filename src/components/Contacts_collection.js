...
export const contactIconDefault = 
<svg viewBox="0 0 212 212" height="212" width="212" preserveAspectRatio="xMidYMid meet" class="rounded-full h-full w-full" version="1.1" x="0px" y="0px" enable-background="new 0 0 212 212">
...
export const contacts = [
    {
        ...
        contactNumber:"contact1_number",
        contactIcon:dp,
        about:"contact1_about",
    },
    {
        contactName:"contact2",
        contactNumber:"contact2_number",
        contactIcon:null,
        about:"contact2_about",
    },
    {
        contactName:"contact3",
        contactNumber:"contact3_number",
        contactIcon:lm,
        about:"contact3_about",
    },
    {
        contactName:"contact4",
        contactNumber:"contact4_number",
        contactIcon:null,
        about:"contact4_about",
    },
    {
        contactName:"contact5",
        contactNumber:"contact5_number",
        contactIcon:car,
        about:"contact5_about",
    },
    {
        contactName:"contact6",
        contactNumber:"contact6_number",
        contactIcon:null,
        about:"contact6_about",
    },
    {
        contactName:"contact7",
        contactNumber:"contact7_number",
        contactIcon:anas_dp,
        about:"contact7_about",
    },
    {
        contactName:"contact8",
        contactNumber:"contact8_number",
        contactIcon:null,
        about:"contact8_about",
    },
    {
        contactName:"contact9",
        contactNumber:"contact9_number",
        contactIcon:daya_dp,
        about:"contact9_about",
    },
    {
        contactName:"contact10",
        contactNumber:"contact10_number",
        contactIcon:null,
        about:"contact10_about",
    },
];

export default function Contacts_collection() {
  return (
    <div>
