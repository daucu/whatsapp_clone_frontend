...
export const groupIconDefault = 
<svg viewBox="0 0 212 212" height="212" width="212" preserveAspectRatio="xMidYMid meet" class="ln8gz9je ppled2lx h-full w-full" fill="white">
...
export default function Groups_collection() {
  return (
    <div></div>
  )
}
